...
export function QuoteSection() {
  ...
  return (
    <section ref={ref} className="py-12 md:py-24 bg-green-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            <div className="md:col-span-9">
              ...
              <motion.p
                ...
                className="text-2xl sm:text-4xl md:text-5xl text-gray-900 font-bold mb-6 sm:mb-8 leading-relaxed text-right"
              ...
              <motion.p
                ...
                className="text-sm sm:text-lg md:text-xl text-gray-700 leading-relaxed"
              >
