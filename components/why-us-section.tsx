    ...
    <section ref={ref} className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 items-start">
          ...
          {/* Right cards */}
          <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 gap-0 border border-gray-100">
            {reasons.map((r, i) => (
              <motion.div
                key={r.title}
                ...
                className="group p-8 border-b border-r border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors"
              >
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <h3 className="font-bold text-gray-900 text-base mb-2 group-hover:text-primary transition-colors">
                      {r.title}
                    </h3>
